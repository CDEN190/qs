...
var splitKeyIntoSegments = function splitKeyIntoSegments(givenKey, options) {
    ...
    while (segmentStart > -1 && i < options.depth) {
        ...
        var bracketDepth = 1;
        while (segmentEnd < key.length && bracketDepth > 0) {
            var currentChar = key.charAt(segmentEnd);
            if (currentChar === '[') {
                bracketDepth += 1;
            } else if (currentChar === ']') {
                bracketDepth -= 1;
        ...
        i += 1;
        segment = key.slice(segmentStart, segmentEnd);
        ...
        segmentStart = key.indexOf('[', segmentEnd);
    }
